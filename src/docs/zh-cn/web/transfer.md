...
```html
<template>
  <o-transfer v-model="value" :data="data"></o-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <o-transfer
      ...
      @change="handleChange"
      :data="data">
      <o-button class="transfer-footer" slot="left-footer" size="small">操作</o-button>
      <o-button class="transfer-footer" slot="right-footer" size="small">操作</o-button>
    </o-transfer>
  </div>
