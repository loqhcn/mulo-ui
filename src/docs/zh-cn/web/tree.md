...
:::demo
```html
<o-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></o-tree>
...
<div class="buttons">
  <o-button @click="getCheckedNodes">通过 node 获取</o-button>
  <o-button @click="getCheckedKeys">通过 key 获取</o-button>
  <o-button @click="setCheckedNodes">通过 node 设置</o-button>
  <o-button @click="setCheckedKeys">通过 key 设置</o-button>
  <o-button @click="resetChecked">清空</o-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <o-button size="mini" type="text" on-click={ () => this.append(data) }>Append</o-button>
              <o-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</o-button>
            </span>
          </span>);
      }
    }
