...
<template>
  ...
  <o-button :plain="true" @click="openVn">VNode</o-button>
</template>
...
```html
<template>
  <o-button :plain="true" @click="open2">成功</o-button>
  <o-button :plain="true" @click="open3">警告</o-button>
  <o-button :plain="true" @click="open1">消息</o-button>
  <o-button :plain="true" @click="open4">错误</o-button>
</template>
...
```html
<template>
  <o-button :plain="true" @click="openCenter">文字居中</o-button>
</template>
...
```html
<template>
  <o-button :plain="true" @click="openHTML">使用 HTML 片段</o-button>
</template>
