  ...
  export default {
    ...
    render(h) {
      ...
      let triggerElm = !splitButton
        ? this.$slots.default
        : (<o-button-group>
          <o-button type={type} size={dropdownSize} nativeOn-click={handleMainButtonClick}>
            {this.$slots.default}
          </o-button>
          <o-button ref="trigger" type={type} size={dropdownSize} class="el-dropdown__caret-button">
